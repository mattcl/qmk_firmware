...
[_BL] = KEYMAP(
  ...
  KC_LCTL, KC_LGUI, KC_LALT,                      KC_SPC,                             KC_NO,  KC_RALT, KC_RGUI, MO(_FL), MO(_F2)),
...
[_FL] = KEYMAP(
  ...
  _______, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, _______, KC_GRV , _______, LSFT(KC_INS), \
