...
#define MC_SPC LT(FN_LAYER, KC_SPC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  // The left spacebar is tap for space, hold for fn
	[BASE_LAYER] = LAYOUT( \
		...
		KC_LCTL, KC_LGUI, KC_LALT, MC_SPC, OSL(OSHOT_LAYER), KC_SPC, KC_RALT, KC_RCTL, KC_LEFT, KC_RIGHT, KC_DOWN \
  ),
  ...
  // The right spacebar is tap for space, hold for fn
	[LSPC_LAYER] = LAYOUT( \
		...
		KC_RCTL, KC_A,    KC_S,    KC_D,   KC_F,             KC_G,   KC_H,    KC_J,    KC_K,    KC_L,     KC_SCLN,  KC_QUOT, KC_ENT,
		KC_LSFT, KC_NO,   KC_Z,    KC_X,   KC_C,             KC_V,   KC_B,    KC_N,    KC_M,    KC_COMM,  KC_DOT,   KC_SLSH, KC_RSFT, KC_UP,
		KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, OSL(OSHOT_LAYER), MC_SPC, KC_RALT, KC_RCTL, KC_LEFT, KC_RIGHT, KC_DOWN \
  ),
