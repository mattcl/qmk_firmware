...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [OSHOT_LAYER] = LAYOUT_base( \
    _______, M(GPMD_PAUSE), M(GPMD_PREV), M(GPMD_NEXT), _______, _______, _______, _______, _______,        M(TPRV),        M(TNXT),    M(GPMD_DOWN), M(GPMD_UP), M(UBIS), \
    ...
    _______, _______,       _______,      _______,      _______, RGB_TOG, _______, BL_BRTG, BL_DEC,         BL_INC,         BL_TOGG,    _______,      _______,    \
