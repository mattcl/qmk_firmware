...
[_QWERTY] = LAYOUT( \
  ...
  KC_LCTL, KC_LCTL, KC_LALT, KC_LGUI, LOWER, LT(UTIL, KC_SPC), LT(UTIL, KC_SPC), RAISE, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
),
 ...
 */
[_RAISE] = LAYOUT( \
  _______, _______, KC_F1,  KC_F2,  KC_F3,  KC_BSPC, KC_PERC, KC_ASTR, KC_7, KC_8,   KC_9,    KC_MINS, \
